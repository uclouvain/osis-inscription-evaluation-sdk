...
class MesProgrammesApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.liste_inscriptions_programmes_endpoint = _Endpoint(
            settings={
                'response_type': (MesFormations,),
                'auth': [
                    'Token'
                ],
                'endpoint_path': '/mes_programmes/',
                'operation_id': 'liste_inscriptions_programmes',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
    ...
    def liste_inscriptions_programmes(
        self,
        **kwargs
    ):
        """liste_inscriptions_programmes  # noqa: E501

        Renvoie les programmes auxquels l'utilisateur (étudiant) est inscrit pour l'année courante  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.liste_inscriptions_programmes(async_req=True)
        >>> result = thread.get()
        ...
        return self.liste_inscriptions_programmes_endpoint.call_with_http_info(**kwargs)
